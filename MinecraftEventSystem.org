...
- BlockPlaced :: Message is published when a player places a block
  ...
  #+end_src
- PlayerDamaged :: Message is published when a player takes damage.
  #+begin_src json
  {
  ...
  #+end_src
- PlayerDoesDamaged :: Message is published when a player does damage.
  #+begin_src json
  {
  ...
  #+end_src
- PlayerDamagesPlayer :: Message is published when a player does damage to another player.
  #+begin_src json
  {
